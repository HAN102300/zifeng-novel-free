...
const DEFAULT_SOURCE = {
  ...
  bookSourceGroup: '默认',
  enabled: true,
  header: `{\n'User-Agent': 'okhttp/4.9.2','client-device': '2d37f6b5b6b2605373092c3dc65a3b39','client-brand': 'Redmi','client-version': '2.3.0','client-name': 'app.maoyankanshu.novel','client-source': 'android','Authorization': '${MAOYAN_AUTH_TOKEN}'\n}`,
  ...
  ruleToc: {
    ...
    chapterUrl: `$.path@js:java.aesBase64DecodeToString(result,"${MAOYAN_KEY}","AES/CBC/PKCS5Padding","${MAOYAN_IV}")`,
